    ...
    private var header: some View {
        VStack(spacing: 8) {
            ...
            Text("Tip jar")
                ...
                .foregroundStyle(Brand.gradient)
            Text("\(Brand.name) is free, forever. If it earned a spot on your phone, you can drop a little something in the jar — totally optional. 🌿")
                .font(.callout)
    ...
    private var thankYou: some View {
        VStack(spacing: 16) {
            ...
            Text("Thank you!")
                ...
                .foregroundStyle(Brand.gradient)
            Text("This genuinely makes someone's day. \(Brand.name) stays free for everyone — you just made it easier to keep going.")
                .font(.callout)
                .multilineTextAlignment(.center)
                .foregroundStyle(.primary)
                .fixedSize(horizontal: false, vertical: true)
